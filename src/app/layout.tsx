...
const SITE_DESCRIPTION =
  "신혼생활은 결혼·신혼부부·신랑신부가 꼭 챙겨야 할 2026년 정부 지원, 신혼부부 특공, 전세대출, 출산지원금, 부모급여, 세액공제를 AI가 맞춤으로 알려주는 대한민국 대표 신혼생활 플랫폼입니다.";
const SITE_KEYWORDS = [
  "신혼생활",
  "신혼부부",
  "신랑",
  ...
  "@graph": [
    {
      ...
      description:
        "신혼부부·예비부부·신랑신부를 위한 정책·혜택 AI 상담 플랫폼. 청약, 전세대출, 출산지원금, 연말정산 등 결혼·신혼 관련 2026년 최신 정보를 맞춤으로 제공합니다.",
    },
    {
      "@type": "WebSite",
      "@id": `${SITE_URL}/#website`,
