...
export const metadata: Metadata = {
  ...
  description:
    "신혼생활은 대한민국 신혼부부·예비부부·신랑신부가 결혼·신혼집·출산·세금까지 꼭 챙겨야 할 2026 정부 지원금을 AI가 맞춤으로 안내하는 신혼 전용 플랫폼입니다. 신혼부부 특공·공공임대·출산지원금·부모급여를 3초만에 확인하세요.",
  ...
  "@graph": [
    {
      ...
      inLanguage: "ko-KR",
      description:
        "신혼부부, 신랑, 신부를 위한 2026 정부 지원 정책·혜택 AI 상담 서비스. 청약, 공공임대, 출산지원금, 부모급여, 연말정산을 한 번에.",
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "2026년 기준 신혼부부가 꼭 챙겨야 할 대표 혜택은 ① 신혼부부 특별공급(새 아파트 우선 배정), ② 신생아 특공(소득 무관 100% 추첨), ③ 행복주택·국민임대 등 공공임대(시세의 60~80%), ④ 첫만남이용권 200만원, ⑤ 부모급여 월 100만원, ⑥ 혼인신고 세액공제입니다.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text:
              "혼인신고 전이라도 청약통장 가입·유지, 공공임대(행복주택·국민임대) 자격 확인, 맞벌이 소득 기준 점검, 연말정산 공제 전략, 지자체별 결혼장려금 확인을 추천드립니다. 신혼생활 AI에게 물어보면 커플 상황에 맞춰 순서를 정리해줍니다.",
          },
        },
        {
          "@type": "Question",
    ...
    <div className="pb-4">
      ...
      <header className="sr-only">
        ...
        <p>
          ...
          안내합니다. 신혼부부 특공, 신생아 특공, 행복주택·국민임대, 첫만남이용권,
        ...
        <div className="space-y-3 pt-2">
          ...
          <details className="bg-white border border-warm-border rounded-lg p-3">
            ...
            <p className="text-[12px] text-warm-text-secondary mt-2 leading-[1.7]">
              ...
              청약, 공공임대, 출산지원금, 부모급여, 연말정산 혜택을 한 곳에서
              확인할 수 있습니다.
            </p>
          </details>
          <details className="bg-white border border-warm-border rounded-lg p-3">
