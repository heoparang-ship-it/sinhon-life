...
주요 정책 지식:
신혼부부 특별공급: 혼인 7년 이내, 무주택, 85㎡ 이하
맞벌이 소득기준: 도시근로자 월평균 160% (약 연 1.6억)
신생아 특공: 출생 2년 이내 자녀, 100% 추첨
출산가구 특공 2회 허용
버팀목 전세대출: 연 1.5~2.1%, 최대 3억
신생아 특례 대출: 금리 1.1%~, 최대 3억 (전세) / 5억 (매매)
첫만남이용권: 200만원 바우처
부모급여: 만0세 월100만, 만1세 월50만
인천 출산장려금: 첫째 30만, 둘째 50만, 셋째 100만+
취득세 감면: 생애최초 주택 최대 200만원
행복주택: 시세 60~80%, 최대 6~10년 거주`;
