...
function SearchHero() {
  const [chips, setChips] = useState<string[]>(["#신혼집"]);
  return (
    <div
      style={{
        position: "relative",
        ...
        >
          ...
          <span
            style={{
              ...
              fontWeight: 500,
              paddingLeft: 8,
              borderLeft: "1px solid rgba(120,140,170,0.18)",
            }}
          >
            #
          </span>
...
const SEARCH_CARDS = [
  {
    tags: ["#신혼집", "#셀프인테리어"],
    title: "15평 빌라, 6개월 셀프 인테리어 기록",
    dur: "0:48",
    label: "reel · 신혼집",
  },
  {
    tags: ["#신혼집", "#원룸"],
    title: "원룸 신혼집도 충분히 예쁠 수 있다",
    dur: "0:54",
    label: "reel · 신혼집",
  },
  {
    tags: ["#신혼집", "#정리"],
    title: "드레스룸이 없을 때 옷장 정리법",
    dur: "0:42",
    label: "reel · 정리",
  },
  {
    tags: ["#신혼집", "#투자"],
    title: "신혼집 첫 1년, 가구 투자 후회 없는 5가지",
    dur: "1:18",
    label: "reel · 가구",
  },
];
