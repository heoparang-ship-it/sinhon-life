...
function QuizScreen({
  ...
  return (
    <section className="px-5 pt-3">
      ...
      {/* 하단 CTA — sticky */}
      <div className="fixed inset-x-0 bottom-0 z-30 mx-auto max-w-[420px] px-5 pb-[max(16px,env(safe-area-inset-bottom))] pt-3 bg-gradient-to-t from-white via-white/95 to-white/0 lg:absolute">
        <button
          type="button"
          onClick={onNext}
